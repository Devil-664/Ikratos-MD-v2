...
//AVISOS DE MENSAJE
const smsAvisoRG = () => { return `RESULTADOS\n\n` }
...
const smsRowner = () => { return `${global.lenguajeGB['smsAvisoAG']()} ¡¡𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙪𝙨𝙖𝙙𝙤 𝙥𝙤𝙧 𝙢𝙞 𝙋𝙧𝙤𝙥𝙞𝙚𝙩𝙖𝙧𝙞𝙤/𝙖 (𝙤𝙬𝙣𝙚𝙧) 𝙙𝙚𝙡 𝙗𝙤𝙩!!` }//NUMERO DE BOT
const smsOwner = () => { return `${global.lenguajeGB['smsAvisoAG']()} ¡¡𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙪𝙨𝙖𝙙𝙤 𝙥𝙤𝙧 𝙢𝙞 𝙋𝙧𝙤𝙥𝙞𝙚𝙩𝙖𝙧𝙞𝙤/𝙖 (𝙤𝙬𝙣𝙚𝙧) 𝙙𝙚𝙡 𝙗𝙤𝙩!!` }//OWNER
const smsMods = () => { return `${global.lenguajeGB['smsAvisoAG']()} ¡¡𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙪𝙩𝙞𝙡𝙞𝙯𝙖𝙙𝙤 𝙥𝙤𝙧 𝙢𝙤𝙙𝙚𝙧𝙖𝙙𝙤𝙧𝙚𝙨 𝙮 𝙚𝙡 𝙥𝙧𝙤𝙥𝙞𝙚𝙩𝙖𝙧𝙞𝙤/𝙖 (𝙤𝙬𝙣𝙚𝙧) 𝙙𝙚𝙡 𝙗𝙤𝙩!!` }//MODERADORES
const smsPremium = () => { return `${global.lenguajeGB['smsAvisoAG']()} ¡¡𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙪𝙩𝙞𝙡𝙞𝙯𝙖𝙙𝙤 𝙥𝙤𝙧 𝙪𝙨𝙪𝙖𝙧𝙞𝙤 𝙥𝙧𝙚𝙢𝙞𝙪𝙢 𝙮 𝙚𝙡 𝙥𝙧𝙤𝙥𝙞𝙚𝙩𝙖𝙧𝙞𝙤/𝙖 (𝙤𝙬𝙣𝙚𝙧) 𝙙𝙚𝙡 𝙗𝙤𝙩!!` }//USUARIOS PREMIUM
const smsGroup = () => { return `${global.lenguajeGB['smsAvisoAG']()} ¡¡𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤  𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙪𝙩𝙞𝙡𝙞𝙯𝙖𝙙𝙤 𝙚𝙡 𝙜𝙧𝙪𝙥𝙤!!` }//PARA GRUPOS
const smsPrivate = () => { return `${global.lenguajeGB['smsAvisoAG']()} ¡¡𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙨𝙚 𝙥𝙪𝙚𝙙𝙚 𝙪𝙩𝙞𝙡𝙞𝙯𝙖𝙧 𝙖𝙡 𝙥𝙧𝙞𝙫𝙖𝙙𝙤 𝙙𝙚𝙡 𝙗𝙤𝙩!!` }//AL PRIVADO
const smsAdmin = () => { return `${global.lenguajeGB['smsAvisoAG']()} ¡¡𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙨𝙚 𝙥𝙪𝙚𝙙𝙚 𝙪𝙨𝙖𝙧 𝙥𝙤𝙧 𝙖𝙙𝙢𝙞𝙣 𝙙𝙚𝙡 𝙜𝙧𝙪𝙥𝙤!!` }//ADMINS
const smsBotAdmin = () => { return `${global.lenguajeGB['smsAvisoAG']()} ¡¡𝙋𝙖𝙧𝙖 𝙥𝙤𝙙𝙚𝙧 𝙪𝙨𝙖𝙧 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙚𝙡 𝙗𝙤𝙩 (𝙮𝙤) 𝙣𝙚𝙘𝙚𝙨𝙞𝙩𝙤 𝙖𝙙𝙢𝙞𝙣, 𝙝𝙖𝙜𝙖 𝙦𝙪𝙚 𝙗𝙤𝙩 𝙨𝙚𝙖 𝙖𝙙𝙢𝙞𝙣 𝙥𝙖𝙧𝙖 𝙥𝙤𝙙𝙚𝙧 𝙪𝙨𝙖𝙧 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤!!` }//BOT CON ADMIN
const smsUnreg = () => { return `${global.lenguajeGB['smsAvisoAG']()} ¡¡🙌 𝙃𝙀𝙔 𝘼𝙇𝙏𝙊, 𝙉𝙊 𝙀𝙎𝙏𝘼 𝙍𝙀𝙂𝙄𝙎𝙏𝙍𝘼𝘿𝙊!! 🙌\n𝙋𝙖𝙧𝙖 𝙥𝙤𝙙𝙚𝙧 𝙪𝙨𝙖𝙧 𝙚𝙡 𝙗𝙤𝙩 𝙣𝙚𝙘𝙚𝙨𝙞𝙩𝙖 𝙧𝙚𝙜𝙞𝙨𝙩𝙧𝙖𝙧𝙩𝙚,  𝙪𝙨𝙖 𝙚𝙡 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 /𝙫𝙚𝙧𝙞𝙛𝙞𝙘𝙖𝙧  ` }//VERIFICAR
const smsRestrict = () => { return `${global.lenguajeGB['smsAvisoAG']()} ¡¡𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙚𝙨𝙩𝙖 𝙙𝙚𝙨𝙖𝙘𝙩𝙞𝙫𝙖𝙙𝙤 𝙥𝙤𝙧 𝙢𝙞 𝙘𝙧𝙚𝙖𝙙𝙤𝙧 !!` }//RESTRINGIR COMANDO
...
const smsCont3 = () => { return `*—◉ 𝑼𝒔𝒖𝒂𝒓𝒊𝒐𝒔:*`}
const smsCont4 = () => { return `*—◉ 𝑪𝒐𝒎𝒂𝒏𝒅𝒐:*`}
const smsCont5 = () => { return `*️—◉ 𝑬𝒓𝒓𝒐𝒓:*`}
...
const smsCont9 = () => { return `${global.lenguajeGB['smsAvisoAG']()}*𝑵𝒆𝒄𝒆𝒔𝒊𝒕𝒂 𝒆𝒍 𝒏𝒊𝒗𝒆𝒍 ➡️*`}
...
//_antispam.js
const smsNoSpam = () => { return `🤨 No hagas spam, no podra usar al bot por 20 Minuto`}

//_antispam_.js
const smsNoSpam2 = () => { return `Fue desbaneado despues de 20 Minuto. Por favor no haga spam!!`}
